...
class HierGraphAttNet(nn.Module):
    def __init__(self, vector_size, sent_hidden_size=50, batch_size=256):
        ...
        self.attention = MUSEAttention(d_model=100, d_k=100, d_v=100, h=8)
    ...
    def graph_match(self, input_1, input_2):
        ...
        attention_x = self.attention(input_1, input_2, input_1)
        attention_y = self.attention(input_2, input_1, input_2)
